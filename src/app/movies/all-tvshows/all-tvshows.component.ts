...
export class AllTvshowsComponent implements OnInit {
  ...
  thrillerTvShows(genre:any){
    this.api.getMovies().subscribe(
      (data:any)=>{
        // console.log(data,"allMovies#");
        this.tvShowsResult=data.movies[0].results;
        this.tvShowsResult= this.tvShowsResult.filter((item:any)=> item.genre_ids[0]==53 || item.genre_ids[1]==53 || item.genre_ids[2]==53  )
        this.genre=genre;
      })
